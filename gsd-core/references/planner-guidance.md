...
**Test:** Could a different Claude instance execute without asking clarifying questions? If not, add specificity. See @D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/planner-antipatterns.md for vague-vs-specific comparison table.
