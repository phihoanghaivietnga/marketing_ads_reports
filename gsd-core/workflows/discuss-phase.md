...
<required_reading>
@D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/domain-probes.md
@D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/gate-prompts.md
@D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/universal-anti-patterns.md
</required_reading>
...
if [ -f "D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/USER-PROFILE.md" ]; then
  ADVISOR_MODE=true
else
  ADVISOR_MODE=false
fi
...
Read `@D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/scout-codebase.md` — it contains the phase-type→map selection table, single-read rule, no-maps fallback, and `<codebase_context>` output schema. Then execute:
...
```
Apply each entry in `activeHooks` per @D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/loop-hook-dispatch.md. Empty list → continue to `analyze_phase`.
</step>
...
```
Apply each entry in `activeHooks` per @D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/loop-hook-dispatch.md. Empty list → continue to `confirm_creation`.
</step>
