...
ones). Reference: @D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / D:/projects/vietnga/marketing-analytics-dashboard.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/bin/lib/edge-probe.cjs" \
  "D:/projects/vietnga/marketing-analytics-dashboard/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/templates/spec.md.
