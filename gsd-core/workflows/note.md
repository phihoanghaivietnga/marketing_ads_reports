...
- **Global scope**: `D:/projects/vietnga/marketing-analytics-dashboard/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/projects/vietnga/marketing-analytics-dashboard/notes/`)
...
2. Glob `D:/projects/vietnga/marketing-analytics-dashboard/notes/*.md` (if directory exists) — global notes
...
Global (D:/projects/vietnga/marketing-analytics-dashboard/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/projects/vietnga/marketing-analytics-dashboard/notes/` — works in any directory
