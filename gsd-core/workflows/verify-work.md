...
<template>
@D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/workflows/transition.md`.
...
- Follow @D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/workflows/diagnose-issues.md
