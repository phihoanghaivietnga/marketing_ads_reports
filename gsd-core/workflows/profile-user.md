...
Key references:
- @D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/ui-brand.md (display patterns)
- @D:/projects/vietnga/marketing-analytics-dashboard/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/USER-PROFILE.md"
...
```bash
cp "D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/USER-PROFILE.md" "D:/projects/vietnga/marketing-analytics-dashboard/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/user-profiling.md`
...
Reference: @D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global .clinerules" -- "Add profile to D:/projects/vietnga/marketing-analytics-dashboard/.clinerules for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at D:/projects/vietnga/marketing-analytics-dashboard/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to D:/projects/vietnga/marketing-analytics-dashboard/.clinerules"
...
```bash
BACKUP_PATH="D:/projects/vietnga/marketing-analytics-dashboard/USER-PROFILE.backup.md"
```
...
Your profile:    D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   D:/projects/vietnga/marketing-analytics-dashboard/skills/gsd-dev-preferences/SKILL.md
  ✓ .clinerules section       <resolved claude_md_path, default ./.cline/.clinerules>
  ✓ Global .clinerules        D:/projects/vietnga/marketing-analytics-dashboard/.clinerules
```
