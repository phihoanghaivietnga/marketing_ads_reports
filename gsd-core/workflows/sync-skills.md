...
INSTALL_JS_GLOBAL="D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
