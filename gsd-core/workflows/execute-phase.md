...
@D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/agent-contracts.md
@D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/context-budget.md
@D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/gates.md
</required_reading>
...
- Executor agents omit extended deviation rule examples and checkpoint examples from inline prompt — load on-demand via @D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/executor-examples.md
- Planner agents omit extended anti-pattern lists and specificity examples from inline prompt — load on-demand via @D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/planner-antipatterns.md
...
```
Pure doc-only / config-only / test-only tasks return `is_behavior_adding=false` and are exempt. When the gate trips, Read `D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/execute-mvp-tdd.md` for the exact halt report format.
</step>
...
2. For each plan (sequentially, ignoring wave grouping):
   ...
   c. **If "Execute":** Read and follow `D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/workflows/execute-plan.md` **inline**
...
@D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/execute-phase-wave-guard.md

@D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/execute-phase-context-guard.md
   ...
   **Sequential dispatch for parallel execution (waves with 2+ agents):**
   ...
   Agent(
     ...
     prompt="
       ...
       @D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/checkpoints.md
       @D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/tdd.md
       @D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/worktree-path-safety.md
       ${CONTEXT_WINDOW < 200000 ? '' : '@D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/executor-examples.md'}
       </execution_context>
...
@D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/execute-phase-between-wave-reset.md
...
Read and follow `D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/workflows/transition.md`, passing through the `--auto` flag so it propagates to the next phase invocation.
