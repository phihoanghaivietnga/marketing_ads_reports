...
```
Agent(
  prompt="Read D:/projects/vietnga/marketing-analytics-dashboard/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/templates/VALIDATION.md`
