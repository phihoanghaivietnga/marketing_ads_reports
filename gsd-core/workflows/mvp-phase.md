...
<required_reading>
@D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/user-story-template.md
@D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/spidr-splitting.md
@D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/spidr-splitting.md`. Briefly:
