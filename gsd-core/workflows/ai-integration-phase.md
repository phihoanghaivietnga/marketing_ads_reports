...
<required_reading>
@D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/ai-frameworks.md
@D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read D:/projects/vietnga/marketing-analytics-dashboard/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/projects/vietnga/marketing-analytics-dashboard/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/projects/vietnga/marketing-analytics-dashboard/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/projects/vietnga/marketing-analytics-dashboard/agents/gsd-eval-planner.md for instructions.
