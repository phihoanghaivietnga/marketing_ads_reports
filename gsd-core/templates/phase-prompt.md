...
<!-- For checkpoint task examples and patterns, see @D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/checkpoints.md -->
...
See `D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/tdd.md` for TDD plan structure.
...
See `D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/templates/user-setup.md` for full schema and examples
...
See `D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/workflows/verify-phase.md` for verification logic.
