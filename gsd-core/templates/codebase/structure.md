...
- Usage: Reference from command with `@D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to D:/projects/vietnga/marketing-analytics-dashboard/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/projects/vietnga/marketing-analytics-dashboard/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
