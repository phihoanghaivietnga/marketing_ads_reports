...
<required_reading>
@D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/verification-overrides.md
...
@D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/thinking-models-verification.md

At verification decision points, reference calibration examples:
@D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/few-shot-examples/verifier.md
...
**When the phase under verification has `mode: mvp` in ROADMAP.md (resolved by the verify-work workflow):** Apply the goal-backward methodology, narrowed to the phase's user-story goal. Required reading: `@D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/verify-mvp-mode.md`.
