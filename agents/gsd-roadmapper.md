...
Reference full template: `D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/templates/state.md`.
