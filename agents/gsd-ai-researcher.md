...
<required_reading>
Read `D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
