...
**Verification depth scales with `asvs_level`** (see @D:/projects/vietnga/marketing-analytics-dashboard/gsd-core/references/security-asvs-levels.md for full definitions):
